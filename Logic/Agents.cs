...
namespace Logic.Agents
{
    ...
    public interface IAgent
    {
        ...
        IReadOnlyList<CompoundExpression> Desires { get; }    // instead of collections, might these be stacks or trees with task/subtask or goal/subgoal structures, perhaps weighted sets of stacks or trees?
        IReadOnlyList<CompoundExpression> Intentions { get; } //

        // should these be parameters to plan generation and/or to plan evaluation and comparison?
        IReadOnlyList<CompoundExpression> Principles { get; }
    }
}