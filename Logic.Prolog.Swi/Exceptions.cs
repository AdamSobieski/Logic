...
namespace Logic.Prolog.Swi.Exceptions
{
    ...
    public class PlException : Exception
    {
        ...
        public PlException(PrologTerm term)
        {
    ...
    public class PlTypeException : PlException
    {
        ...
        /// <inheritdoc />
        public PlTypeException(PrologTerm term)
            : base(term)
        {
        }
		...
		public PlTypeException(string expected, PrologTerm actual)
            : base(
    ...
    public class PlDomainException : PlException
    {
        ...
        /// <inheritdoc cref="PlException" />
        public PlDomainException(PrologTerm term)
            : base(term)
        { }
        /*
